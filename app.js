...
const {initialOptions, hospitalInfoOptions, againOptions, previousStep} = require('./options.js')
const {hospitalHistory, contactsFile, paidServicesFile, infoForPatients, 
	managmentsHospital, diagnostic, medicalParts, searchByContacts} = require('./read_files.js')
const {contacts, price, importantNumbers, infoOnManagment} = require('./words_by_search.js')
